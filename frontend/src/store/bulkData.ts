...
export const initialWalletTransactions: MetaWalletTransaction[] = [
  {
    ...
    amount: 967.20,
    currency: '₹',
    description: '1,240 Marketing messages for campaign "Qiyam Autumn Business Solutions Launch"',
    timestamp: 'Sep 18, 2026, 10:15 AM',
    balanceAfter: 2450.00,
    campaignId: 'cmp-1',
    campaignName: 'Qiyam Autumn Business Solutions Launch',
  },
  {
    id: 'tx-102',
    type: 'debit',
    ...
    amount: 256.80,
    currency: '₹',
    description: '856 Utility reminder messages for "Client Maintenance & Service Reminder"',
    timestamp: 'Sep 16, 2026, 09:20 AM',
    balanceAfter: 3417.20,
    campaignId: 'cmp-2',
    campaignName: 'Client Maintenance & Service Reminder',
  },
  {
    id: 'tx-103',
    type: 'credit',
    ...
    timestamp: 'Sep 12, 2026, 02:00 PM',
    balanceAfter: 3674.00,
  },
  {
    id: 'tx-104',
    type: 'debit',
    ...
    amount: 1185.60,
    currency: '₹',
    description: '1,520 Marketing messages for "Koyilandy Region Business Outreach"',
    timestamp: 'Sep 14, 2026, 11:45 AM',
    balanceAfter: 2488.40,
    campaignId: 'cmp-3',
    campaignName: 'Koyilandy Region Business Outreach',
  },
  {
    id: 'tx-105',
    type: 'credit',
    ...
    timestamp: 'Sep 01, 2026, 12:00 AM',
    balanceAfter: 3674.00,
  },
];
...
const rawBulkCampaigns = [
  {
    id: 'cmp-1',
    name: 'Qiyam Autumn Business Solutions Launch',
    description: 'Official launch broadcast for Qiyam enterprise WhatsApp CRM & automation suite',
    type: 'Marketing',
    recipients: 1240,
    delivered: 1210,
    deliveredPercent: 97.6,
    failed: 30,
    failedPercent: 2.4,
    pending: 0,
    ...
    scheduledOn: 'Sep 18, 2026, 10:00 AM',
    completedOn: 'Sep 18, 2026, 10:35 AM',
    status: 'Completed',
    templateName: 'Offer Announcement',
    audienceListName: 'All Active Customers',
    messageText: '🎉 Special Autumn Solutions Announcement from Qiyam Ventures!\n\nGet ready to supercharge your business operations with our automated WhatsApp CRM and multi-agent AI tools. Enjoy 25% off setup this month.\n\nReply YES or click below to claim your consultation.',
  },
  {
    id: 'cmp-2',
    name: 'Client Maintenance & Service Reminder',
    description: 'Automated quarterly service maintenance notifications for commercial contracts',
    type: 'Utility',
    recipients: 856,
    delivered: 838,
    ...
    scheduledOn: 'Sep 16, 2026, 09:00 AM',
    completedOn: 'Sep 16, 2026, 09:42 AM',
    status: 'Completed',
    templateName: 'Appointment Reminder',
    audienceListName: 'Service AMC Clients',
    messageText: 'Hi Valued Partner,\nThis is a friendly reminder that your scheduled technical audit and system servicing is booked for tomorrow between 10:00 AM and 1:00 PM.\n\nOur certified engineer will arrive on schedule.\n\nThank you,\nQiyam Ventures Operations',
  },
  {
    id: 'cmp-3',
    name: 'Koyilandy Region Business Outreach',
    description: 'Regional promotion for business partners in Kozhikode & Koyilandy',
    type: 'Marketing',
    recipients: 1520,
    delivered: 1485,
    deliveredPercent: 97.7,
    failed: 35,
    failedPercent: 2.3,
    pending: 0,
    createdOn: 'Sep 14, 2026',
    createdAt: '2026-09-14T11:20:00.000Z',
    createdBy: 'Priya Sharma',
    scheduledOn: 'Sep 14, 2026, 11:00 AM',
    completedOn: 'Sep 14, 2026, 11:45 AM',
    status: 'Completed',
    templateName: 'Welcome Message',
    audienceListName: 'Regional Leads (Kerala)',
    messageText: 'Hello, we are thrilled to expand our direct support and dedicated dispatch station across Koyilandy and Calicut! Connect directly with your dedicated account manager today.',
  },
  {
    id: 'cmp-4',
    name: 'Pending Invoices & AMC Follow-up',
    description: 'Automated utility billing reminder for pending enterprise invoices',
    type: 'Utility',
    recipients: 412,
    delivered: 405,
    ...
    scheduledOn: 'Sep 10, 2026, 02:00 PM',
    completedOn: 'Sep 10, 2026, 02:25 PM',
    status: 'Completed',
    templateName: 'Payment Reminder',
    audienceListName: 'Payment Pending',
    messageText: 'Dear Partner, your quarterly maintenance invoice is ready for processing. Please click below to download your tax invoice or proceed via UPI / NetBanking.',
  },
  {
    id: 'cmp-5',
    name: 'Executive VIP Client Briefing',
    description: 'Exclusive quarterly briefing and feature rollout for VIP account holders',
    type: 'Marketing',
    recipients: 280,
    delivered: 280,
    deliveredPercent: 100.0,
    failed: 0,
    failedPercent: 0.0,
    pending: 0,
    ...
    createdBy: 'Rahul Mehta',
    scheduledOn: 'Sep 05, 2026, 04:30 PM',
    completedOn: 'Sep 05, 2026, 04:45 PM',
    status: 'Completed',
    templateName: 'Booking Confirmation',
    audienceListName: 'VIP Clients',
    messageText: 'Greetings from Qiyam Ventures. As a VIP tier partner, your account is upgraded with 24/7 dedicated priority SLA and priority cloud API routing. Thank you for your continued partnership.',
  },
  {
    id: 'cmp-6',
    name: 'Customer Satisfaction & Review Check',
    description: 'Post-service engagement follow-up',
    type: 'Engagement',
    recipients: 650,
    delivered: 632,
    ...
    failedPercent: 2.8,
    pending: 0,
    createdOn: 'Sep 01, 2026',
    createdAt: '2026-09-01T12:00:00.000Z',
    createdBy: 'Arjun Nair',
    scheduledOn: 'Sep 01, 2026, 12:00 PM',
    completedOn: 'Sep 01, 2026, 12:20 PM',
    status: 'Completed',
    templateName: 'Feedback Request',
    audienceListName: 'Recent Service Completed',
    messageText: 'Hi, thank you for choosing Qiyam Ventures! How was your recent support experience with our team? Please reply with a score from 1 to 5.',
  },
];

export const initialBulkCampaigns: BulkCampaign[] = rawBulkCampaigns.map((c) => {
  const timeStr = c.scheduledOn ? c.scheduledOn.split(', ')[1] || '10:30 AM' : '10:30 AM';
  return {
    ...c,
    totalRecipients: c.recipients,
    deliveredCount: c.delivered,
    readCount: Math.round(c.delivered * 0.74),
    repliedCount: Math.round(c.delivered * 0.14),
    failedCount: c.failed,
    cost: Number((c.recipients * (c.type === 'Utility' ? 0.30 : 0.78)).toFixed(2)),
    audienceListName: c.audienceListName || 'All Active Customers',
    createdAt: c.createdAt || new Date().toISOString(),
    status: c.status.toUpperCase(),
    recipientsList: generateCampaignRecipients(c.id, c.recipients, c.delivered, c.failed, timeStr),
  };
});
