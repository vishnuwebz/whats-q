      ...
      <div className="p-3 sm:p-5 md:p-6 space-y-4 sm:space-y-6 w-full max-w-full min-w-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 min-w-0">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 sm:gap-6 min-w-0">
            ...
            {/* 2. Qiyam AI Copilot Card (Spacious default size with comfortable chat portion) */}
            <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm flex flex-col min-h-[460px] sm:min-h-[520px] overflow-hidden min-w-0">
              {/* Header */}
              ...
              {/* Chat Messages Stream - Default comfortable height */}
              <div ref={aiChatContainerRef} className="flex-1 overflow-y-auto p-4 space-y-3 text-xs scrollbar-thin min-h-[260px] sm:min-h-[300px]">
                {aiMessages.map((msg, i) => {
                  ...
                  return (
                    ...
                    >
                      {isAi && (
                        <div className="w-7 h-7 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center shrink-0 mt-0.5 shadow-2xs font-bold text-xs">
                      ...
                      >
                        ...
                        >
                          <span>{msg.time}</span>
                          {!isAi && <CheckCheck className="w-3.5 h-3.5 text-emerald-200" />}
                        </div>
                      </div>
                      {!isAi && (
                        <div className="w-7 h-7 rounded-xl bg-emerald-100 text-emerald-800 flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">
                          RM
                        </div>
                      )}
                    </div>
                ...
                {isAiThinking && (
                  <div className="flex items-start gap-2.5">
                    <div className="w-7 h-7 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center shrink-0 mt-0.5 shadow-2xs">
                    ...
                    <div className="bg-purple-50/80 border border-purple-100 text-purple-800 rounded-2xl rounded-tl-xs px-3.5 py-2.5 text-xs flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-purple-700 italic">Analyzing operations & pipeline...</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="px-4 py-2.5 border-t border-slate-100 bg-slate-50/50">
                <div className="flex items-center justify-between mb-2 px-1">
                  ...
                  <span className="text-[10px] text-purple-600 font-semibold">1-Click Prompts</span>
                </div>
                <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none pb-1">
                  <button
                    onClick={() => handleAskAi("Show today's schedule")}
                    className="text-xs px-3 py-1.5 rounded-xl bg-white hover:bg-purple-50 border border-slate-200 hover:border-purple-300 text-slate-700 hover:text-purple-700 font-medium transition-all shrink-0 flex items-center gap-1.5 shadow-2xs cursor-pointer active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="text-xs px-3 py-1.5 rounded-xl bg-white hover:bg-amber-50 border border-slate-200 hover:border-amber-300 text-slate-700 hover:text-amber-700 font-medium transition-all shrink-0 flex items-center gap-1.5 shadow-2xs cursor-pointer active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="text-xs px-3 py-1.5 rounded-xl bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-300 text-slate-700 hover:text-blue-700 font-medium transition-all shrink-0 flex items-center gap-1.5 shadow-2xs cursor-pointer active:scale-95"
                  >
              ...
              <form
                ...
                className="p-3.5 sm:p-4 border-t border-slate-200/80 bg-white"
              >
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full pl-3.5 pr-11 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                  />
                  <button
                    type="submit"
                    disabled={!aiInput.trim() || isAiThinking}
                    className="w-8 h-8 rounded-lg bg-purple-600 hover:bg-purple-700 disabled:bg-slate-300 text-white flex items-center justify-center absolute right-1.5 top-1/2 -translate-y-1/2 shadow-sm transition-all cursor-pointer active:scale-95"
                  >
