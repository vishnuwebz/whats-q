    ...
    <div className="flex-1 flex flex-col bg-[#F8FAFC] min-h-screen overflow-hidden font-sans">
      ...
      <div className="flex-1 flex overflow-hidden border-t border-slate-200">
        ...
        <div className="w-[450px] bg-[#0F172A]/5 p-6 flex flex-col items-center justify-between border-l border-slate-200 shrink-0 overflow-y-auto select-none">
          ...
          {activeTemplate && (
            <div className="w-full mt-4 flex items-center justify-center gap-2 text-xs">
              <button
                type="button"
                onClick={() => handleEdit(activeTemplate)}
                className="px-4 py-2 bg-white hover:bg-slate-50 border border-slate-300 text-slate-700 font-bold rounded-xl flex items-center gap-1.5 shadow-sm transition-all"
              >
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl flex items-center gap-1.5 shadow-sm shadow-emerald-700/20 active:scale-95 transition-all"
              >
