      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-emerald-600 mt-1">15 / 18</div>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-amber-500 mt-1">2</div>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-red-500 mt-1">1</div>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-black text-purple-600 mt-1">8h 54m</div>
            <div className="text-[11px] text-purple-600 mt-0.5">Normal work shift</div>
          </div>
        </div>

        {/* Attendance Table (Matching photo_29) */}
