      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden p-3 sm:p-5 md:p-6 flex gap-3 sm:gap-4 items-stretch scrollbar-thin min-h-0">
        {stages.map((stage) => {
          ...
          return (
            <div
              key={stage.id}
              className="w-[85vw] sm:w-72 max-w-[320px] sm:max-w-none bg-slate-100/80 rounded-2xl border border-slate-200 flex flex-col h-full max-h-full min-h-0 shrink-0 shadow-sm"
            >
