...
export const SystemUpdateModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-200/90 overflow-hidden relative font-sans animate-in zoom-in-95 duration-200 select-none">
        
        {/* Modal Top Hero Banner */}
        <div className="bg-gradient-to-br from-slate-950 via-emerald-950 to-teal-900 p-6 text-white relative overflow-hidden border-b border-emerald-500/20">
          ...
          <div className="relative z-10 flex items-start gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-950/50 shrink-0 border border-emerald-400/30">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 bg-slate-50/90 p-3.5 rounded-2xl border border-slate-200 text-xs">
          ...
          <div className="flex items-start gap-3 bg-emerald-50/90 border border-emerald-200/80 p-3 rounded-2xl">
          ...
          {isUpdatingSystem && (
            <div className="space-y-2 p-4 bg-slate-900 rounded-2xl text-white shadow-inner animate-in fade-in duration-200">
          ...
          <div className="flex items-center justify-between gap-3 pt-2">
            {!isUpdatingSystem && versionInfo.update_available && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-100/80 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-all cursor-pointer hover:shadow-sm active:scale-95"
              >
                Update Later
              </button>
            )}
            ...
            <div className="flex items-center gap-2 ml-auto">
              {isUpToDate ? (
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-700 hover:to-teal-800 text-white font-bold text-xs flex items-center gap-2 shadow-lg shadow-emerald-700/30 hover:shadow-emerald-700/40 active:scale-95 transition-all disabled:opacity-50 cursor-pointer"
                >
                  {isUpdatingSystem ? (
                    <>
                      <RefreshCw className="w-3.5 h-3.5 animate-spin" />
